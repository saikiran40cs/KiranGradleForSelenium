...
public class ErrorHandling extends DriverFactory {
	...
	public void assertEquals(Object expected, Object actual, String message) {
		...
		if (expected != null && expected.equals(actual)) {
			...
			Reporter.log("Error Snapshot is Located in : " + PathConstants.ErrorReportPath + Captialize(runOnBrowser) + "_"
					+ executingTestCaseName + PathConstants.DateFormat + ".jpg");
